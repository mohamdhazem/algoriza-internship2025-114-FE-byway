...
export const PaymentDetails = () => {
    ...
    return (
        <div className="font-inter px-5 sm:px-10 lg:px-20 pt-8 pb-20 md:py-8 min-h-[150px]">
            <div className="flex flex-wrap justify-start items-center gap-1.5 text-sm mb-4">
                ...
                <div className="flex items-center gap-0 sm:gap-1.5">
                    ...
                    <ChevronRight className="text-[#E2E8F0]" size={18} />
                    <p className="text-[#2563EB] text-sm">Shopping Cart</p>
                </div>
            </div>
