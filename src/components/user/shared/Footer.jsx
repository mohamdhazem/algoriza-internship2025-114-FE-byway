            ...
            <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
                ...
                <div className="flex flex-col items-start gap-1 w-full lg:w-auto">
                    ...
                    <div className="flex flex-wrap justify-start items-center gap-4 pt-4">
                        <img src={`${import.meta.env.BASE_URL}icons/social/facebook.svg`} className="w-8 h-8 sm:w-10 sm:h-10 rounded-full p-1.5 cursor-pointer bg-white" alt="facebook" />
                        <img src={`${import.meta.env.BASE_URL}icons/social/github.svg`} className="w-8 h-8 sm:w-10 sm:h-10 rounded-full p-1.5 cursor-pointer bg-white" alt="github" />
                        <img src={`${import.meta.env.BASE_URL}icons/social/google.svg`} className="w-8 h-8 sm:w-10 sm:h-10 rounded-full p-1.5 cursor-pointer bg-white" alt="google" />
                        <img src={`${import.meta.env.BASE_URL}icons/social/x.svg`} className="w-8 h-8 sm:w-10 sm:h-10 rounded-full p-1.5 cursor-pointer bg-white" alt="x" />
                        <img src={`${import.meta.env.BASE_URL}icons/social/microsoft.svg`} className="w-8 h-8 sm:w-10 sm:h-10 rounded-full p-1.5 cursor-pointer bg-white" alt="microsoft" />
                    </div>
                </div>
            </div>
        </div>
