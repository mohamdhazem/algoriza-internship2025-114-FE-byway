                ...
                <div className="flex flex-col-reverse md:flex-row md:items-center gap-3">
                    <div className="flex justify-between gap-2">
                        ...
                        <Link
                            type="button"
                            to={"/Courses/Add"}
                            className="flex items-center justify-center gap-1 h-10 w-fit sm:max-w-60 text-white text-sm font-medium bg-gray-950 px-5 py-2.5 rounded-lg hover:bg-gray-800"
                        >
                            Add Course
                        </Link>
                    ...
                    <div className="flex justify-between items-center gap-2">
                        ...
                        <div
                            ...
                            className="flex flex-col items-center justify-center w-10 h-9 border rounded-lg border-gray-100 shadow-soft cursor-pointer hover:bg-gray-50 gap-1"
                        >
