...
export const UpdateInstructor = ({ setShowEditForm, instructorId }) => {
    ...
    const handleChange = (e) => {
        ...
        setFormData((prev) => ({
            ...prev,
            [name]: name === "jobTitle" ? Number(value) : value,
        }));
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Build FormData object (supports text + files)
            ...
            const response = await api.put(`/Instructor/${instructorId}`, formData, {
                headers: {
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <div className="flex justify-center items-center w-20 h-20 bg-[#F2F2F2] rounded-full py-5 my-6 relative">
                        ...
                        <span
                            ...
                            className="flex items-center justify-center text-white border-2 border-white rounded-full bg-[#5879DC] w-9 h-9 absolute top-12 left-11 cursor-pointer"
                        >
                            <CameraIcon size={21} />
                        </span>
                    </div>
